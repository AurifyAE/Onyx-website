    ...
    <Section id="about" variant="plain">
      ...
      >
        ...
        >
          ...
          commercial license with a clear focus on precious metals and
          gemstones.
        </Typography>
      </Box>
        ...
        <Grid item xs={12} md={7}>
          ...
          >
            <Stack spacing={1}>
              ...
              <Typography
                sx={{ color: "text.primary", fontWeight: 700, lineHeight: 1.8 }}
              >
              ...
              >
                ...
                Location: Dubai, UAE
                <br />
                Legal Type: Limited Liability Company - Single Owner (L.L.C -
                SO)
              </Typography>
            </Stack>
            <Chip
